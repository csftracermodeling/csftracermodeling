...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data", required=True, type=str, help="Path to image in mgz format.")
    ...
    c_data_fenics = read_image(filename=parserargs["data"], functionspace=V, mask=parserargs["mask"])
