...
if __name__ == "__main__":
    ...
    parser.add_argument("--hdf5_file", required=True, type=str,
                        help="File storing the FEniCS function")
    ...
    parser.add_argument("--skip_value", type=float,
    ...
    assert hdf5_name in hdf_keys, "only the functions listed above are stored in the hdf file"
